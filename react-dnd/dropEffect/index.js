...
export default class CustomizeDropEffects extends Component {
  render() {
    return (
      <div>
        <p>
          <b><a href="https://github.com/react-dnd/react-dnd/tree/master/examples/05%20Customize/Drop%20Effects">Browse the Source</a></b>
        </p>
        <p>
...
ReactDOM.render(<CustomizeDropEffects/>,document.getElementById('react-content'));
