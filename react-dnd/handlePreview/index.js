...
export default class CustomizeHandlesAndPreviews extends Component {
  render() {
    return (
      <div>
        <p>
          <b><a href="https://github.com/react-dnd/react-dnd/tree/master/examples/05%20Customize/Handles%20and%20Previews">Browse the Source</a></b>
        </p>
        <p>
...
ReactDOM.render(<CustomizeHandlesAndPreviews/>,document.getElementById('react-content'));
